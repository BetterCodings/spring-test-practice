...
class BookControllerTest {
    ...
    @Autowired
    private ObjectMapper objectMapper; // JSON <->J Java 객체 변환
    ...
    void getBookById_NotFound() throws Exception {
        ...
        mockMvc.perform(get("/api/books/999"))
                ...
                .andExpect(jsonPath("$.message").value(String.format("ID %d인 책을 찾을 수 없습니다", BookId)));
    }
    ...
    class CreateBook {
        ...
        void createBook_Success() throws Exception {
            ...
            BookCreateRequest request
                    = new BookCreateRequest("클린 코드", "로버트 마틴", "123-0123456789", 30000, null);

            BookResponse response
                    = new BookResponse(1L, "클린 코드", "로버트 마틴", "123-0123456789", 30000, null);
