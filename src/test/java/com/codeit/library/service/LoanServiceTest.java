...
class LoanServiceTest {
    ...
    class CreateLoan {
        ...
        void createLoan_Success() {
            ...
            Book book = new Book(bookId, "클린코드", "로버트 마틴", "978-0123456789", 30000);
            ...
            when(loanRepository.countByMemberIdAndReturnDateIsNull(memberId))
                    .thenReturn(2L);
            when(loanRepository.existsByBookIdAndReturnDateIsNull(bookId))
                    .thenReturn(false);
            when(loanRepository.existsOverdueLoan(memberId))
                    .thenReturn(false);
            ...
            LoanCreateRequest request = new LoanCreateRequest(memberId, book.getId());
            ...
            // 실수로 메서드 호출 상황을 연출하지 않아도 테스트가 통과되는 경우가 있습니다.
            // 그걸 확인하는 용도 입니다.
        ...
        void createLoan_MemberNotFound() {
            ...
            // 회원이 없는데 대출이 실행될 리는 없기 때문에
            // loanRepository의 save가 절대 불리지 않았다는 것을 검증.
        ...
        @Test
        @DisplayName("대출 시 반납 예정일은 14일 후로 설정된다")
    ...
    class ReturnBook {
        ...
        void returnBook_Success() {
            ...
            Member member = new Member(memberId, "홍길동", "abc1234@naver.com");
            Book book = new Book(bookId, "클린 코드", "로버트 마틴", "978-123456789", 30000);
