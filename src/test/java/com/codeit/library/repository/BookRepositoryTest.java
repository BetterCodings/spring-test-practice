...
class BookRepositoryTest {
    ...
    class Search {
        ...
        void findByAuthor() {
            ...
            assertThat(books)
                    .extracting("title")
                    .containsExactlyInAnyOrder("클린 코드", "클린 아키텍처"); // 순서는 상관 없을 때
        }
        ...
        void findByISBN() {
            // given
            bookRepository.save(new Book("클린 코드", "로버트 마틴", "978-0132456266", 30000));

            // when
            Optional<Book> book = bookRepository.findByIsbn("978-0132456266");
